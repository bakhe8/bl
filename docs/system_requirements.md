...
- صيغ الملفات المسموحة: `.xlsx` فقط. رفض `.xls`, `.xlsm`, `.csv`, والملفات الماكرو أو غير القياسية. الترميز المطلوب UTF-8 حصراً، مع رسالة رفض واضحة عند ظهور حروف مشوهة.
- حجم الملف الأقصى المقترح: 1MB (حد تقني للأمان والأداء). الاستخدام المعتاد المستهدف بين 10–100 صف (حوالي بضعة مئات كيلوبايت). عند تجاوز 1MB يُعرض تحذير.
...
- المخرجات النهائية دائماً بالعربية، حتى مع إدخال مختلط EN/AR.
...
- لا دعم لزر تراجع (Undo)؛ القرارات تحفظ مباشرة.
