...
- حد تشغيلي مقترح للقواميس في LocalStorage: 4MB، مع تحذير عند الوصول إلى 90% (~3.6MB). عند تجاوز الحد يُطلب تنظيف/دمج المتقارب أو الاعتماد على ملف JSON خارجي أكبر.
- لا يوجد Auto-Backup؛ تحذير للمستخدم مرة واحدة بأن حذف بيانات المتصفح يمسح التعلم.
