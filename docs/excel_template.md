...
## ملف مثال جاهز
- ملف اختبار موثّق في `test-data/sample.xlsx` يحوي 10 صفوف متنوعة (عربي/إنجليزي، بنوك/موردون معروفون وجدد، أخطاء مطبعية، تواريخ وصيغ مبالغ مختلفة) لاستخدامه في التحقق اليدوي وتشغيل المسار الكامل.
